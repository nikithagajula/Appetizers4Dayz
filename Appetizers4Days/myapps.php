<?php  
	...
	$sql= "SELECT * FROM Appetizer WHERE username='$username'";
        $result = mysqli_query($con, $sql);
        $apps = '';
        while($row = mysqli_fetch_array($result)) {
        		$apps .= '<h1>Name: '.$row['name'] . "\n";
        		$apps .= '<h2> ⇒ Ingredients: '.$row['Ingredients'] . "\n";
        		$apps .= '<h2> ⇒ Recipe: '.$row['recipe'] . "\n";
        	}
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><?php echo $apps ?>
                    </h2>
