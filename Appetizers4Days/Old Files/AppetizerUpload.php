...
$appname = mysqli_real_escape_string($con, $_POST['appetizer_name']);
$recipe = mysqli_real_escape_string($con, $_POST['appetizer_recipe']);

$sql = "INSERT INTO Appetizer(name, recipe) VALUES ('$appname', '$recipe')";
